...
# Arduino'nun bağlı olduğu portu ve baud hızını ayarla
arduino = serial.Serial(port='COM6', baudrate=9600, timeout=.1)  # Portu kendi sisteminize göre değiştirin
time.sleep(2)  # Arduino'nun bağlantı için hazır olmasını bekle
  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        # El açık ve kapalı durumunu belirle
